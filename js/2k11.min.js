var script=document.getElementById("modernizr").src;var scpath=script.split("/").slice(0,-1).join("/")+"/";Modernizr.load([{test:Modernizr.mq("only all and (min-width: 0px)"),nope:scpath+"respond.min.js"},{test:Modernizr.touch,yep:scpath+"ios-orientationchange.min.js"}]);
