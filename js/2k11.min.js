var script=document.getElementById("modernizr").src;var path=script.split("/").slice(0,-1).join("/")+"/";Modernizr.load([{test:Modernizr.mq("only all and (min-width: 0px)"),nope:path+"respond.min.js"},{test:Modernizr.touch,yep:path+"ios-orientationchange.min.js"},{test:Modernizr.input.placeholder,nope:[path+"onfontresize.jquery.min.js",path+"placeholder_polyfill.jquery.min.js"]}]);
