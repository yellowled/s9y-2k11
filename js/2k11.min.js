var script=document.getElementById("modernizr").src;var path=script.split("/").slice(0,-1).join("/")+"/";console.log(path);Modernizr.load([{test:Modernizr.mq("only all and (min-width: 0px)"),yep:path+"respond.min.js"},{test:Modernizr.touch,nope:path+"ios-orientationchange.min.js"},{test:Modernizr.input.placeholder,yep:[path+"placeholder_polyfill.jquery.min.combo.js"]}]);
