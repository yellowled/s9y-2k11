...
t=Math.abs(z.y);u=Math.abs(z.z);if((!p.orientation||p.orientation===180)&&(s>7||((u>6&&t<8||u<8&&t>6)&&s>5))){if(v){A();}}else{if(!v){w();}}}p.addEventListener("orientationchange",w,false);
