...
}("autocomplete autofocus list placeholder max min multiple pattern required step".split(" "));}var at="2.5.2",ar={},aq=!0,ap=av.documentElement,ao="modernizr",an=av.createElement(ao),am=an.style,al=av.createElement("input"),ak=":)",aj={}.toString,ai=" -webkit- -moz- -o- -ms- ".split(" "),ah="Webkit Moz O ms",ag=ah.split(" "),af=ah.toLowerCase().split(" "),ae={},ad={},ac={},ab=[],aa=ab.slice,Z,Y=function(t,s,r,q){var p,o,n,h=av.createElement("div"),g=av.body,b=g?g:av.createElement("body");
if(parseInt(r,10)){while(r--){n=av.createElement("div"),n.id=q?q[r]:ao+(r+1),h.appendChild(n);}}return p=["&#173;","<style>",t,"</style>"].join(""),h.id=ao,b.innerHTML+=p,b.appendChild(h),g||ap.appendChild(b),o=s(h,t),g?h.parentNode.removeChild(h):b.parentNode.removeChild(b),!!o;
...
}function n(B){function h(){var b=k.cloneNode(!1);return l.shivMethods?(n(b),b):b;}function d(e){var c=(z[e]||(z[e]=y(e))).cloneNode(!1);return l.shivMethods&&!s.test(e)?k.appendChild(c):c;
}var A,z={},y=B.createElement,x=B.createDocumentFragment,w=o(),k=x(),i=w.length;while(i--){A=w[i],z[A]=y(A),k.createElement(A);}B.createElement=d,B.createDocumentFragment=h;
}function m(d){var c;return d.documentShived?d:(l.shivCSS&&!r&&(c=!!p(d,"article,aside,details,figcaption,figure,footer,header,hgroup,nav,section{display:block}audio{display:none}canvas,video{display:inline-block;*display:inline;*zoom:1}[hidden]{display:none}audio[controls]{display:inline-block;*display:inline;*zoom:1}mark{background:#FF0;color:#000}")),l.shivMethods&&!q&&(c=!n(d)),c&&(d.documentShived=c),d);
}var t=v.html5||{},s=/^<|^(?:button|iframe|input|script|textarea)$/i,r,q;(function(){var j,f=u.createElement("a"),e=v.getComputedStyle,b=u.documentElement,a=u.body||(j=b.insertBefore(u.createElement("body"),b.firstChild));
a.insertBefore(f,a.firstChild),f.hidden=!0,f.innerHTML="<xyz></xyz>",r=(f.currentStyle||e(f,null)).display=="none",q=f.childNodes.length==1||function(){try{u.createElement("a");
}catch(d){return !0;}var g=u.createDocumentFragment();return typeof g.cloneNode=="undefined"||typeof g.createDocumentFragment=="undefined"||typeof g.createElement=="undefined";
}(),a.removeChild(f),j&&b.removeChild(j);})();var l={elements:t.elements||"abbr article aside audio bdi canvas data datalist details figcaption figure footer header hgroup mark meter nav output progress section summary time video".split(" "),shivCSS:t.shivCSS!==!1,shivMethods:t.shivMethods!==!1,type:"default",shivDocument:m};
